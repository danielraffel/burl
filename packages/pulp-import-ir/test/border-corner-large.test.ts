...
describe('authored large corner radius', () => {
    it('preserves the authored value for paint-time CSS used-value scaling', () => {
        const observed: ObservedDomNode = { sourceId: 'corner', tagName: 'div',
            computedStyle: { display: 'block', borderTopLeftRadius: '1.67772e+07px', borderTopRightRadius: '1.67772e+07px', borderBottomLeftRadius: '1.67772e+07px', borderBottomRightRadius: '1.67772e+07px' },
        ...
        expect(typed.paint?.borderTopLeftRadius).toBe(16777200);
        expect(typed.paint?.borderTopRightRadius).toBe(16777200);
        ...
        expect(native.root.style?.borderTopLeftRadius).toBe(16777200);
        expect(native.root.style?.borderTopRightRadius).toBe(16777200);
    });
});
